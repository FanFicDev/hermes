...
class WanderingInnAdapter(WordpressAdapter):
    def __init__(self) -> None:
        ...
        self.sub_patt = "<a href=['\"]https://wanderinginn[^'\"]*['\"]>\s*(<span style=\"float:right;\">|)\s*(Last|Previous|Next)\s+Chapter\s*(</span>|)\s*</a>"
        self.title = 'The Wandering Inn'
        self.fandom = 'The Wandering Inn'
        self.ageRating = 'M'
        self.author = 'pirate aba'
        self.authorUrl = 'https://www.patreon.com/user?u=4240617'
        self.description = '''

...
skitterClients: List[SkitterClient] = [
		SkitterClient(baseUrl='https://primary/skitter/',
			apiKey='primaryApiKey',
			uname='skitter_api', upass='primaryPass'),
		SkitterClient(baseUrl='https://secondary/skitter/',
			apiKey='secondaryApiKey',
			uname='skitter_api', upass='secondaryPass'),
	]
